...
<Lab bind:contents {licensed}>
  ...
  <p>
    The <button class="text-button" on:click={() => showModal1 = true}>density function</button> for the Poisson <button class="text-button" on:click={() => showModal2 = true}>distribution</button> is
